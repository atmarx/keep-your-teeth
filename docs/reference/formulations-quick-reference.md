...
| Calcium carbonate powder (optional) | 1/2 tablespoon | Additional buffering, remineralization support |

**Instructions:**
1. Combine ingredients in a clean, dry jar with a tight-fitting lid
2. Shake or stir to mix thoroughly
3. Store in a cool, dry place
4. Makes approximately 3.5 tablespoons of dry mix (enough for ~20-30 uses)

### Usage

1. Add 1/2 to 1 teaspoon of dry mix to 8 oz (240 mL) warm water
2. Stir until dissolved (calcium carbonate won't fully dissolve—that's fine)
3. Swish vigorously for 30-60 seconds
4. Spit; do not rinse with plain water afterward
5. Use after meals, before bed, or whenever desired
...
**Instructions:**
1. Add salt and baking soda to warm (not hot) water in reservoir
2. Swirl gently to dissolve
3. Use on medium-low pressure setting
4. After use, run a brief reservoir of plain water through the device to prevent mineral buildup
...
**Instructions:**
1. Place sage in a heat-proof cup or teapot
2. Pour just-boiled water over leaves
3. Cover and steep for 10-15 minutes (longer = stronger)
4. Strain out leaves
5. Add salt if desired and stir to dissolve
6. Cool to comfortable temperature
7. Use as a rinse; swish for 30-60 seconds
8. Can be stored in refrigerator for 2-3 days
...
| Honey (optional) | 1/2 teaspoon (for drinking; omit for pure rinse) |
...
4. Strain out ginger
5. Cool to comfortable temperature
6. Use as a rinse, or drink (with honey if desired) for systemic anti-inflammatory benefit
...
1. Cut a thin slice of fresh ginger
2. Place against the affected gum area
3. Leave for 5-10 minutes
4. The initial tingling is normal; remove if irritation occurs
...
**Instructions:**
1. Add propolis tincture to warm water
2. Add salt if desired
3. Stir well
4. Swish for 30-60 seconds
5. Spit
...
1. Place 1-2 drops of clove oil on a cotton ball or swab
2. Apply directly to the painful tooth or surrounding gum
3. Hold in place for 1-2 minutes
4. Remove; do not rinse immediately
5. Can repeat every 2-3 hours as needed

**For sensitive individuals (diluted):**
1. Mix 2-3 drops clove oil with 1/2 teaspoon carrier oil
2. Apply as above
...
**Instructions:**
1. Place oil in mouth first thing in the morning (before eating or drinking)
2. Swish gently, pulling oil between teeth
3. Continue for 15-20 minutes (start with 5 minutes if new to practice)
4. Spit into trash (not sink—oil can solidify and clog pipes)
5. Rinse mouth with warm water
6. Proceed with normal brushing routine
...
1. **Rinse** with plain water to clear food particles and begin diluting acids
2. **Chew** xylitol gum (if available) to stimulate saliva and buffer pH
3. **Wait** at least 30 minutes before brushing

### If Acidic Food/Drink Was Consumed

1. **Rinse** with plain water immediately
2. **Follow** with a small sip of your salt/baking soda rinse (even a brief swish helps)
3. **Chew** xylitol gum or have a small piece of cheese
4. **Wait** at least 45-60 minutes before brushing
...
1. **Oil pulling** (optional): 15-20 minutes while preparing for the day
2. **Rinse** with plain water to remove residual oil (if oil pulling) or overnight bacterial accumulation
3. **Brush** with fluoride or n-HAp toothpaste for 2 minutes
4. **Spit** excess toothpaste but **do not rinse** with water (maintains fluoride contact)
5. **Wait** 20-30 minutes before eating (allows remineralization agents to work)

### After Breakfast

1. **Rinse** with water
2. **Chew** xylitol gum for 10-20 minutes
3. **Do not brush again**—you've already brushed; additional brushing is unnecessary and potentially erosive
...
1. **Floss** or use water flosser (with or without salt/baking soda solution)
2. **Brush** with fluoride or n-HAp toothpaste for 2 minutes
3. **Spit** but do not rinse
4. **Optional rinse:** If using a separate fluoride rinse (0.05% NaF), use now, swish for 1 minute, spit
5. **No food or drink** after final rinse (water is acceptable if needed)
